...
namespace TagAndTrack.Components
{
    ...
    /// </summary>
    public class DataTableTemplate : Grid, IDisposable
    {
        private readonly List<PropertyChangedEventHandler> _themeHandlers
        ...
        public DataTableTemplate(IReadOnlyList<SpecimenItem> specimens)
        {
            ...
            PropertyChangedEventHandler idHeaderHandler = (s, e) =>
            {
                if (e.PropertyName == nameof(CurrentTheme.Theme))
                {
            ...
            _themeHandlers.Add(idHeaderHandler);

            // Subscribe to theme changes.
            CurrentTheme.Instance.PropertyChanged += idHeaderHandler;
            ...
            PropertyChangedEventHandler nameHeaderHandler = (s, e) =>
            {
                if (e.PropertyName == nameof(CurrentTheme.Theme))
                {
            ...
            _themeHandlers.Add(nameHeaderHandler);

            // Subscribe to theme changes.
            CurrentTheme.Instance.PropertyChanged += nameHeaderHandler;
            ...
            PropertyChangedEventHandler actionHeaderHandler = (s, e) =>
            {
                if (e.PropertyName == nameof(CurrentTheme.Theme))
                {
            ...
            _themeHandlers.Add(actionHeaderHandler);

            // Subscribe to theme changes.
            CurrentTheme.Instance.PropertyChanged += actionHeaderHandler;
            ...
            foreach (var specimen in specimens)
            {
                ...
                PropertyChangedEventHandler propertyHandler = (s, e) => 
                {
                    if (e.PropertyName == nameof(CurrentTheme.Theme))
                    {
                        border.Stroke = CurrentTheme.Instance.Theme.Borders;
                ...
                _themeHandlers.Add(propertyHandler);

                // Subscribe to theme changes.
                CurrentTheme.Instance.PropertyChanged += propertyHandler;
                ...
                PropertyChangedEventHandler nameHandler = (s, e) =>
                {
                    if (e.PropertyName == nameof(CurrentTheme.Theme))
                    {
                        border.Stroke = CurrentTheme.Instance.Theme.Borders;
                ...
                _themeHandlers.Add(nameHandler);

                // Subscribe to theme changes.
                CurrentTheme.Instance.PropertyChanged += nameHandler;
                ...
                PropertyChangedEventHandler buttonHandler = (s, e) =>
                {
                    if (e.PropertyName == nameof(CurrentTheme.Theme))
                    {
                        border.Stroke = CurrentTheme.Instance.Theme.Borders;
                ...
                _themeHandlers.Add(buttonHandler);

                // Subscribe to theme changes.
                CurrentTheme.Instance.PropertyChanged += buttonHandler;
